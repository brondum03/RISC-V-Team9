...
VL_INLINE_OPT void Vdut___024root___ico_sequent__TOP__0(Vdut___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.ALUout = ((1U == (IData)(vlSelfRef.ALUctrl))
                         ? (vlSelfRef.ALUop1 + vlSelfRef.ALUop2)
...
#endif
            VL_FATAL_MT("/Users/enqilim/iac_labs/RISC-V-Team9/rtl/alu.sv", 5, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("/Users/enqilim/iac_labs/RISC-V-Team9/rtl/alu.sv", 5, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/Users/enqilim/iac_labs/RISC-V-Team9/rtl/alu.sv", 5, "", "Active region did not converge.");
            }

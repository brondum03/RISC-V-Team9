...
#endif
            VL_FATAL_MT("/Users/enqilim/iac_labs/RISC-V-Team9/rtl/alu.sv", 5, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vdut___024root___ctor_var_reset(Vdut___024root* vlSelf) {
    ...
    vlSelf->ALUop1 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 14538662602627186084ull);
    vlSelf->ALUop2 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 1521222783795021337ull);
    vlSelf->ALUctrl = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 1819921640028676982ull);
    vlSelf->ALUout = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10355008715522020790ull);
    vlSelf->EQ = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2604776803757316466ull);
}

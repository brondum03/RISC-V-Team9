...
#endif
            VL_FATAL_MT("/Users/enqilim/iac_labs/RISC-V-Team9/rtl/execute/alu.sv", 14, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vdut___024root___ctor_var_reset(Vdut___024root* vlSelf) {
    ...
    vlSelf->ALUctrl = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 1819921640028676982ull);
